...
description: Then things get difficult
published: 2024-07-18
updated: 2024-09-07
previewImage: ./fediverse.png
---

This blog post is some thoughts on running a fediverse instance after growing one from a single user instance to a community of about 20 friends over a year and a half - a couple things I think went well, what I could've done better, and a caution that it's not always as easy as it seems.
...
There's not too much involved in the technical side, at least on the small scale. (When things scale up it definitely gets a lot more complex - admins like Jo on tech.lgbt deserve a lot of respect for all the work they do to keep an instance of that size running smoothly!)
...
There were some mysterious ongoing issues even the developers seemed to have no clue what to do about (nobody seems to be sure if pleroma/akkoma database "rot" is real or not, which is only spoken about with superstition and in hushed tones), but everything still kept working.

I don't say all of this to boast about how good I am at the technical side of things, but as a caution: **_Being able to handle the technical side of things is not enough for running an instance with other people on it!!!_** You can find the technical part easy, and still find running an instance to be a lot of work.

## The difficult bit

No, the difficult bit of running an instance is the social side - everything that comes with providing a platform for people, and being part of a much wider network of instances containing over a million people.
...
However it also comes with the downside that when there is a legitimate issue or drama, it's been caused by somebody you're close friends with. I feel it's very important to give people leeway and the benefit of the doubt, however you also can't ignore it when they do something wrong. Doing the right thing isn't always easy, but it is right. Not doing so is like building the foundations of your house on something that's bad for house foundations (knowing very little about building houses, I can't really make that metaphor work).

Building a community is also part of it - to me, a good instance feels like it's more than just a collection of accounts that happen to share the same server. I think it was the most important thing that made my instance so special. Leading by example as what you want to see in other people seemed to work for me.

I didn't originally intend for anybody else to be on my instance (it was something I set up for just myself, but then a friend asked if they could move to my instance, and it grew from there), so I didn't have any rules to start with. When a couple people joined I threw a basic set of rules together (no transphobia, racism, harassment, etc), but with so closely limiting who could join in the first place, they served more as a set of guidelines for what other instances would be defederated before rather than being needed for anybody on my instance. If you don't feel like coming up with your own set of rules from scratch, you can do what I did and mostly copy the rules from an instance I trusted. Speaking of:

### On other instances

I don't think the majority of people are actually aware how awful people and the internet can be, which you get a glimpse of when you exist in a space that allows anybody to set up an instance where they can do whatever they want. <!-- not really happy with my wording here, but you get the vibe -->
...
I also put the work into maintaining my own blocklist - this takes a lot of work, and is one of the things that led to me completely burning out. My suggestion is you either:
...
- acknowledge that your moderation will be reactive rather than proactive (if the people on your instance like this approach then great, I've seen it work very well on other instances)

I'd also recommend being as transparent as you can about moderation decisions to everybody on your instance - I understand wanting to keep your instance's blocklist private to avoid scrutiny, but being transparent to the people on your instance about the moderation decisions you're making, why you're making them, and being open to disagreement is not only the right thing to do in my opinion, but it also shows to everybody on your instance the work you're putting in to keep everything running, and helps them trust you running the instance. (I hate analyzing things from that perspective, but I also think it's true)
...
The main thing I now think I could've done better, looking back, is to get help from others. I tried to run everything by myself, and although I did it well, it completely exhausted me and burnt me out, taking months to recover. Having other people to help would've allowed me to feel like I could take breaks, and made running the instance sustainable. I hope I've learnt from this.

I've tried to write something about fedi a couple of times now, but with all the stuff that happened I still don't feel like I can talk about most of it. Writing this blog post in such a general way is the only thing I feel I can do for now, so it'll have to do. Rest in peace, [0w0.is](https://0w0.is/).
